...
map("n", "<leader>wh", ":<C-U>TmuxNavigateLeft<CR>", "[W]indow [h] move one window to the left")
map("n", "<leader>wj", ":<C-U>TmuxNavigateDown<CR>", "[W]indow [j] move one window down or below")
map("n", "<leader>wk", ":<C-U>TmuxNavigateUp<CR>", "[W]indow [k] move one window up or above")
...
map("n", "<leader>gp", CreatePullRequest, "[G]it create [P]ull request")
