...
function obj:updateMicMute(muted)
    ...
    if muted then
        local icon =
            ...
            "https://img.icons8.com/external-anggara-filled-outline-anggara-putra/15/000000/external-mic-off-communication-anggara-filled-outline-anggara-putra.png"
        )
...
obj.mute_menu:setClickCallback(
    function()
        obj:toggleMicMute()
    end
)
